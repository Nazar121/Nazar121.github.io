$(document).ready(function() {
  ...
  function update() {
    ...
    $('.tab-box .tab').removeClass('tab-active'); // знімаємо з неактивного спана клас актив   
    $('.tab-box .tab:nth-child(' + (Math.abs(margin/100) + 1) + ')').addClass('tab-active'); // записуємо індекс кожного елемента якому дається клас актив
  }
});